...
int smithyCard(struct gameState *state, int currentPlayer, int handPos){
      //+3 Cards
      int i;
	//fongas: edited for loop to 3
      for (i = 0; i < 3; i++)	//TODO: CHANGED 3 TO 5 - BUG INTRODUCTED HERE
	{
	  drawCard(currentPlayer, state);
	}
...
int villageCard(struct gameState *state, int currentPlayer, int handPos){
      ...
      //+2 Actions
      //fongas: edited numActions + 2
      state->numActions = state->numActions + 2;	//TODO: CHANGED THE NUMBER OF ACTIONS FROM 2 TO 3
